...
Lê Hồ Mỹ Loan: Chịu trách nhiệm thiết kế bộ khung giao diện Web App bằng Streamlit và lập trình các hàm mô phỏng sự suy biến của ảnh (Nhiễu & Nhòe). 

Lê Xuân Thành: Chịu trách nhiệm mảng không gian, lập trình nhóm thuật toán Xử lý Nhiễu bao gồm Lọc Box, Gaussian, và Median.

Phùng Đoàn Lê Hân: Chịu trách nhiệm mảng tần số, lập trình nhóm thuật toán Xử lý Nhòe thông qua biến đổi Fourier bao gồm Lọc Inverse và Lọc Wiener.

Đặng Lê Khánh Ly: Chịu trách nhiệm thuật toán tăng cường ảnh (Unsharp Masking), xây dựng hàm tính toán các chỉ số đánh giá (MSE, PSNR) và là người trực tiếp lắp ráp (integrate) toàn bộ thuật toán của nhóm vào luồng hoạt động chính của Web App.
